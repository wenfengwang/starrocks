...
StarRocks提供了丰富的函数集合，以便于数据查询和分析。除了常用函数外，StarRocks还支持半结构化函数，如ARRAY、JSON、MAP和STRUCT函数。它也支持高阶[Lambda函数](Lambda_expression.md)。如果这些函数无法满足您的业务需求，您可以使用[Java UDF](JAVA_UDF.md)来编写自定义函数。
...
- [aes_encrypt](./cryptographic-functions/aes_encrypt.md)
- [aes_decrypt](./cryptographic-functions/aes_decrypt.md)
- [base64_decode_binary](./cryptographic-functions/base64_decode_binary.md)
- [base64_decode_string](./cryptographic-functions/base64_decode_string.md)
- [from_base64](./cryptographic-functions/from_base64.md)
- [md5](./cryptographic-functions/md5.md)
- [md5sum](./cryptographic-functions/md5sum.md)
- [md5sum_numeric](./cryptographic-functions/md5sum_numeric.md)
- [sha2](./cryptographic-functions/sha2.md)
- [sm3](./cryptographic-functions/sm3.md)
- [to_base64](./cryptographic-functions/to_base64.md)

## 日期函数

- [add_months](./date-time-functions/add_months.md)
- [adddate, days_add](./date-time-functions/adddate.md)
...
- [exp, dexp](./math-functions/exp.md)
