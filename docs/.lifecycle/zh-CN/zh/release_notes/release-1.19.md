...
* 实现全局运行时过滤器，支持对shuffle join实现运行时过滤器。
...
* 修复Hive外部表空分区问题[# 707](https://github.com/StarRocks/starrocks/pull/707)[# 2082](https://github.com/StarRocks/starrocks/pull/2082)
