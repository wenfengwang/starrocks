...
用于在远程存储系统中创建用于存储数据快照的仓库。仓库用于 [备份和恢复](../../../administration/Backup_and_restore.md) 数据库数据。

> **注意**
>
> 只有拥有系统级 REPOSITORY 权限的用户才能创建仓库。

有关删除仓库的操作，请参考 [DROP REPOSITORY](../data-definition/DROP_REPOSITORY.md) 章节。
